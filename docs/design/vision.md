...
4. **Modern civic planning readability.** Visual polish may borrow broad lessons from Cities: Skylines screenshots: clean dark planning HUDs, bright service/status icons, cool blue active tool accents, legible zoning overlays, modern roads, waterfronts, trees, and dense urban silhouettes. This is a feel and interface-language reference only: no copied assets, silhouettes, UI layouts, names, or source art.
