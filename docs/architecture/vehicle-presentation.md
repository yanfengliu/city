...
- The concise aggregate measurements and provenance are retained in this Markdown section; the raw local traces were reviewed under ignored `output/performance/` and removed afterward.
