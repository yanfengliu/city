...
Task-run evidence remains local regardless of size. Known evidence, coverage, log, browser-run, and review-capture paths are both ignored and rejected from new Git history; tracked docs retain only concise conclusions and reproducible provenance.
