...
export const TRAFFIC_SIGNAL_CORNER_INSET = 0.08;
export const TRAFFIC_SIGNAL_POLE_HALF_WIDTH = 0.018;
export const TRAFFIC_SIGNAL_POLE_HEIGHT = 0.68;
export const TRAFFIC_SIGNAL_HOUSING_BOTTOM = 0.58;
export const TRAFFIC_SIGNAL_HOUSING_TOP = 0.86;
...
export const TRAFFIC_SIGNAL_LENS_HEIGHTS = [0.79, 0.72, 0.65] as const;
