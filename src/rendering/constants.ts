...
// Service structures (player-placed 2x2 amenities: civic buildings and leisure landscapes).
...
export type ServiceKind = 'fireStation' | 'police' | 'clinic' | 'school' | 'park' | 'garden';
